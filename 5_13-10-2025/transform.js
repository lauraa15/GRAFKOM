...
function skalar_array(point_array_awal, titik_putar, sk){
    point_array=[];
    for (var i=0; i<point_array_awal.length;i++){

        point_array.push(skalar_fp(point_array_awal[i],titik_putar,sk));
    }
    // console.log("di fungsi skalarray",point_array, point_array_awal,titik_putar,sk);
    return point_array;
}